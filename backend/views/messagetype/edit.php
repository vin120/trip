			...
			<p>
				<label>
					...
					<select name="status" id=status class='input_select'>
						<option value='1'  <?php echo  $story_type['status'] == 1 ? "selected='seletcted'" : '';?> ><?php echo yii::t('app','可用')?></option>
						<option value='0'  <?php echo  $story_type['status'] == 0 ? "selected='seletcted'" : '';?> ><?php echo yii::t('app','不可用')?></option>
					</select>
				</label>
			</p>
