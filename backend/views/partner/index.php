...
<!-- content start -->
<div class="r content">
	<div class="topNav"><?php echo yii::t('app','合作伙伴管理')?>&nbsp;&gt;&gt;&nbsp;<a href="#"><?php echo yii::t('app','合作伙伴信息')?></a></div>
	...
	?>
		...
		<input type="hidden" id="partner_page" value="<?php echo $partner_page;?>" />
			<thead>
				<tr>
        ...
        <!-- 分页 -->
       <div class="center" id="partner_page_div"> </div>
	</div>
</div>
<!-- content end -->
...
window.onload = function(){
    ...
    <?php $partner_total = (int)ceil($count/10);
	   if($partner_total >1){
	?>
		$('#partner_page_div').jqPaginator({
		    totalPages: <?php echo $partner_total;?>,
		    visiblePages: 10,
		    currentPage: 1,
		    ...
		    onPageChange: function (num, type) {
		    	var this_page = $("input#partner_page").val();
		    	if(this_page==num){$("input#partner_page").val('fail');return false;}

		    	$.ajax({
	                url:"<?php echo Url::toRoute(['getpartnerpage']);?>",
	                type:'get',
	                data:'pag='+num,
	             	dataType:'json',
	            	success:function(data){
	            		...
	            		if(data != 0){
	    	                ...
	    	                $("table#partner_table > tbody").html(str);
	    	            }
	            	}
	            });
