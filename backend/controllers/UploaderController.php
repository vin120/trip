...
class UploaderController extends BaseController
{
     ...
     public function actionImgfileupload(){
     	// var_dump('ImgFileUpload');exit;
     	//传参，判断图片分类上传至不同目录
     	$data = isset($_GET['name'])?$_GET['name']:'apartment_img';
		...
		$target_Dir = Yii::$app->params['img_url_prefix'].$data;
		$upload_Dir = Yii::$app->params['img_url_prefix'].$data;
