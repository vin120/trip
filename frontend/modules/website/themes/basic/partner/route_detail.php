<?php
	$this->title = '珠海正和国际旅游有限公司-推荐路线详情';
	use yii\helpers\Url;
          ...
          <div class="tr-pro_box tr-posr">
            ...
            <div class="tr-posr tr-bgcw" style="height: 95px;">
              <div class="tr-fll tr-u-info tr-mt5" style="margin-left: 0px">
                <h1 class="tr-fz32 tr-ml15 tr-mt5 tr-c666 tr-fll tr-ellipsis" style="width: 900px;font-weight:normal;"><?php echo $route['name']?></h1>
                <div class="tr-cfl">
                  <span class="tr-fz14 tr-c666 tr-pr10 tr-pl10">
                  <i class="tr-dib tr-u-s-h"></i><?php echo $route['author']?>
                  </span>
                  <span class="tr-caf tr-fz14 tr-pr10 tr-pl10 tr-left-text"><?php echo substr($route['time'],0,10)?></span>
                </div>
              </div>
