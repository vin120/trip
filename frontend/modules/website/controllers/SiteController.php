...
class SiteController extends BaseController
{
	...
	public function actionPartner()
	{
		...
		$sql = "SELECT a.* , b.name partner_name  FROM `zh_partner_route` a LEFT JOIN `zh_partner` b ON a.id=b.id WHERE a.status=1 AND b.status=1 ORDER BY a.time DESC LIMIT 3";
